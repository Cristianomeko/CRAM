...
def main(args):
    ...
    checkpoint_fp = '/home/maxu/lxz/HFCAN/training/snapshot/phase1_wpdc_checkpoint_epoch_108.pth.tar'
    arch = 'repvgg'

    checkpoint = torch.load(checkpoint_fp, map_location=lambda storage, loc: storage)['state_dict']
    model = getattr(HRepVGG, arch)()  # 62 = 12(pose) + 40(shape) +10(expression)
